<?php
	...
	$wfsUrl = file_get_contents("http://localhost:8080/geoserver/SLEMAN_COVID19_MAP/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=SLEMAN_COVID19_MAP%3AFAS_KESEHATAN_PT_SLEMAN_RSRUJUKAN_Proj&outputFormat=application%2Fjson");
